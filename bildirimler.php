<?php 
  ...
  // ZAMAN FARKI HESAPLAMA FONKSİYONU
  ...
  // İNGİLİZCE VERİTABANINDAN ÇEK (notifications)
  try {
...
<head>
    ...
    <style>
        ...
        .unread-dot {
            width: 10px; height: 10px; border-radius: 50%; background-color: #0d9488;
        }
    </style>
</head>
<body>
